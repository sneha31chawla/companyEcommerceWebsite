...
// Action to get user details by ID (admin only)
...
// Action to update the logged-in user's profile
...
// Action to delete a user by ID (admin only)
...
// Action to update user information (admin only)
